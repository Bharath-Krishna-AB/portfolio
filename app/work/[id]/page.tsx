...
export default function ProjectDetailsPage({
      ...
      <div className="min-h-screen bg-[#f9f8f4] flex items-center justify-center text-[#121212]">
        <div className="text-center">
          ...
          <button
            ...
            className="border-b border-[#121212] pb-1 uppercase tracking-widest font-mono text-xs hover:text-muted transition-colors hover:-translate-y-0.5 inline-block"
          >
            Return to Works
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-secondary selection:text-white pb-32 transition-colors duration-500">
      ...
      <button
        onClick={() => router.push("/works")}
        className="fixed top-6 sm:top-8 left-6 sm:left-8 z-50 flex items-center gap-2 px-5 py-2.5 bg-black/40 hover:bg-black/60 backdrop-blur-md text-white border border-white/10 rounded-full font-bold text-[10px] font-mono uppercase tracking-[0.2em] shadow-lg hover:scale-[1.02] active:scale-[0.98] transition-all cursor-pointer group"
      >
      ...
      <div className="w-full bg-background relative z-20 -mt-10 rounded-t-[2rem] sm:rounded-t-[4rem] px-6 py-20 sm:py-32 transition-colors duration-500">
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 py-12 md:py-16 border-y border-border mb-24 md:mb-32 max-w-6xl mx-auto">
            ...
            {project.links && (
              <div className="flex flex-col gap-4 col-span-2 md:col-span-1">
                ...
                {project.links.live && (
                  <a href={project.links.live} target="_blank" rel="noopener noreferrer" className="text-sm font-bold text-muted hover:text-foreground hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center gap-2 group">
                    Live Site
                ...
                {project.links.github && (
                  <a href={project.links.github} target="_blank" rel="noopener noreferrer" className="text-sm font-bold text-muted hover:text-foreground hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center gap-2 group">
                    Source Code
                    <svg className="w-3.5 h-3.5 -rotate-45 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M5 12h14M12 5l7 7-7 7" />
                    </svg>
          ...
          <div className="w-full border-t border-border pt-32 pb-16 flex flex-col items-center justify-center text-center">
            ...
            <a href="mailto:bharathkrishna.ab.dev@gmail.com" className="px-8 py-4 bg-foreground text-foreground-inverse rounded-full font-bold uppercase tracking-widest text-xs hover:scale-[1.02] active:scale-[0.98] hover:opacity-85 transition-all duration-300 shadow-xl shadow-black/5">
              Get in Touch
            </a>
          </div>
