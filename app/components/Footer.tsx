...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="relative bg-background py-16 pb-32 transition-colors duration-500">
      ...
      <nav className="fixed bottom-4 sm:bottom-6 left-1/2 -translate-x-1/2 z-50 w-[calc(100%-1rem)] max-w-[360px] sm:w-auto sm:max-w-none flex justify-center">
        <div className="liquid-glass flex items-center justify-center gap-0 sm:gap-1 px-1.5 sm:px-2.5 py-1.5 sm:py-2 rounded-full w-full sm:w-auto">
          {/* Navigation Links */}
          {[
            ...
            <a
              ...
              className="flex items-center justify-center px-2 sm:px-4 py-1.5 sm:py-2 text-[11px] sm:text-sm text-foreground/75 hover:text-foreground transition-colors duration-200 rounded-full hover:bg-foreground/5 shrink-0"
            >
              {link.label}
            </a>
          ))}
          ...
          <a
            href="tel:6235311216"
            className="flex items-center justify-center ml-0.5 sm:ml-1 px-3 sm:px-4 py-1.5 sm:py-2 text-[11px] sm:text-sm bg-foreground text-foreground-inverse rounded-full hover:opacity-80 transition-opacity duration-200 cursor-pointer shrink-0"
          >
            Call me
          </a>
          ...
          <button
            onClick={toggleTheme}
            className="p-1.5 sm:p-2 ml-0.5 sm:ml-1 rounded-full hover:bg-foreground/5 text-foreground transition-colors duration-200 cursor-pointer shrink-0"
